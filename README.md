# nvim-treesitter-queries-surface

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-surface/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-surface/actions/workflows/validate.yml)

Neovim tree-sitter queries for **surface**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-surface",
...
- [ ] Changes are scoped to `surface` — do not include files for other languages
